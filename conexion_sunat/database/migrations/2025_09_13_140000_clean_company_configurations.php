...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Restringir los valores válidos de config_type (PostgreSQL: CHECK CONSTRAINT)
        DB::statement("ALTER TABLE company_configurations DROP CONSTRAINT IF EXISTS chk_config_type");
        DB::statement("ALTER TABLE company_configurations ADD CONSTRAINT chk_config_type
            CHECK (config_type IN ('tax_settings','invoice_settings','gre_settings','document_settings'))");
    ...
    {
        // Revertir: restaurar constraint original sin restricción
        DB::statement("ALTER TABLE company_configurations DROP CONSTRAINT IF EXISTS chk_config_type");
    }
};